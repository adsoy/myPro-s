...
public class Depo {
    ...
    static HashMap<String, Urun> urunlerMap = new HashMap<String, Urun>();           //map olusturdukk
    ...
    public Depo() {
        urunlerMap = new HashMap<String, Urun>();
    }
    ...
    public static void urunTanimlama() {
        ...
        if (urunlerMap.containsKey(id1)) {
            //throw new IdKullanimda("!!!!! id zaten kullanimda");
            System.err.println("depomuzda id numarasi:"+id1+" ile tanimli urun zaten vardir.");
